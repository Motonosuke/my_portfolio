...
import { FONTSIZE, IconProps } from 'types/icon';

export const ZennIcon: React.FunctionComponent<IconProps> = ({ fontSize, ...props }) => (
  <Icon fontSize={FONTSIZE[fontSize === undefined ? 'md' : fontSize]} {...props}>
    <path
